...
```bash
source "${Hiro_HOME:-$HOME/.Hiro}/skills/github/github-auth/scripts/gh-env.sh"
...
gh pr review $PR_NUMBER --approve --body "Reviewed by Hiro. Code looks clean — good test coverage, no security concerns."
