...
// Pure tool action/result description and preview helpers now live in
// inspector-events.ts (unit tested there, no ws/orchestrator dependency).
// Re-bound to their original local names so every call site below is
// unchanged.
const _previewToolArgs = previewToolArgs;
const _previewToolOutput = previewToolOutput;
const _toolActionDescription = toolActionDescription;
const _toolResultDescription = toolResultDescription;
              ...
              if (
                ...
                _sendmiki(ws, {
                  ...
                  payload: {
                    ...
                    kind: streamSawError ? "error" : "normal",
                    model_name: resolvedRunModel,
