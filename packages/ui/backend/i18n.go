...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open owlclaw console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About owlclaw",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit owlclaw",
		Exiting:            "Exiting owlclaw...",
		DocUrl:             "https://docs.owlclaw.io/docs/",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 owlclaw 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 owlclaw",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 owlclaw",
		Exiting:            "正在退出 owlclaw...",
		DocUrl:             "https://docs.owlclaw.io/zh-Hans/docs/",
	},
}
