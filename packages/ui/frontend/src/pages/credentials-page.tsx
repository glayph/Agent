...
import { AnthropicCredentialCard } from "@/features/credentials/components/anthropic-credential-card"
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 gap-4 py-5 lg:auto-rows-fr lg:grid-cols-3">
            ...
            <AnthropicCredentialCard
              ...
              revealedToken={revealedTokens["anthropic"]}
              onRevealToken={() => void revealToken("anthropic")}
              onHideToken={() => hideToken("anthropic")}
            />
            ...
            <AntigravityCredentialCard
              ...
              onStopLoading={stopLoading}
              onSaveToken={() =>
                void saveToken("google-antigravity", antigravityToken.trim())
              }
