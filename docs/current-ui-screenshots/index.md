# Agent Miki — Final UI Screenshot Index

Fresh authenticated browser evidence captured after the final frontend/backend rebuild and local LFM runtime restart. The screenshots use the current light Ink & Lime surface and show the generated Miki brand mark in the primary rail.

| Evidence | Route or scope | What was verified |
|---|---|---|
| `00-final-ui-contact-sheet.webp` | Overview | Compact overview of the final evidence set. |
| `launcher_login.webp` | `/launcher-login` | Login shell, Miki brand mark, and lime sign-in control. |
| `chat_local.webp` | `/` chat workspace | Local `llama.cpp/local-model` run, user dark bubble, assistant light bubble, and no highlighted message Inspector. |
| `plugin_catalog.webp` | `/plugins` | Shared sidebar/top bar, flat plugin tiles, family grouping, and retained catalog inspector. |
| `drive_topbar.webp` | `/drive` | Bespoke Drive header aligned to shared top-bar treatment and rail. |
...
| `04-primary-mark.png` | Generated asset | Primary Miki mark evidence. |
| `05-favicon-96.png` | Generated asset | Favicon evidence. |
| `06-apple-touch-icon.png` | Generated asset | Apple touch icon evidence. |
