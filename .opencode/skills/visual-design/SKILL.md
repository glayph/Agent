---
name: visual-design
description: Use when the user asks about UI design, visual design, design tools, color systems, typography, spacing, design tokens, or design-to-code handoff. Provide design system specs, color palettes, typography scales, and Figma/design tool guidance.
---
