...
description: Use when the user asks about responsive design, mobile-first, cross-device layout, adaptive UI, breakpoints, or responsive images. Build layouts that work from 320px mobile to ultrawide desktop using mobile-first methodology.
---
