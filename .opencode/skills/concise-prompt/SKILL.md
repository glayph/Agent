---
name: concise-prompt
description: Use when the user asks for concise prompt engineering, instruction compression, or token-efficient prompting. Compress verbose instructions into minimal, high-density prompts without losing meaning.
---
