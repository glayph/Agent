...
description: Use when the user asks for structured output, JSON mode, tool call formatting, output schemas, or integration between LLM outputs and external tools. Produce validated, schema-compliant structured data from LLM responses for direct consumption by tools, APIs, or pipelines.
---
