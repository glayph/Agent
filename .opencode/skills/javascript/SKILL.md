---
name: javascript
description: Use when the user asks about JavaScript, ES6+, modern JS, async patterns, array methods, closures, promises, or JavaScript best practices. Write modern, idiomatic JavaScript with ES2022+ features.
---
