---
name: wireframing
description: Use when the user asks for wireframes, prototypes, mockups, UI layout planning, or interaction design. Generate text-based wireframes, screen flows, and interactive prototype specs for web and mobile.
---
