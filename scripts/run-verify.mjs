...
function main() {
  ...
  // Step 2: Build declaration-producing dependency packages before strict typechecking.
  // Workspace typechecks import @miki/* from each package's published dist/ entrypoint.
  // A fresh checkout has no dist/ yet, so this bootstrap build is required and is
  // intentionally kept separate from the full native/runtime production build below.
  log("Step 2/5: Bootstrapping workspace declarations and running strict typechecks...");
